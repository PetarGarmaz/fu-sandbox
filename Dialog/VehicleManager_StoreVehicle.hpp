class VehicleManager_StoreVehicle {
	idd = 4609;
	...
	class Controls {
		...
		{
			idc = 4612;
			text = "<t size=""1.5"">Store vehicle</t>"; //--- ToDo: Localize;
		...
		class Name: RscText {
			...
			text = "Name your vehicle:"; //--- ToDo: Localize;
			x = 0.376219 * safezoneW + safezoneX;
		...
		class ConfirmButton: RscButton {
			...
			tooltip = "Confirm the name"; //--- ToDo: Localize;
		};
	};
};